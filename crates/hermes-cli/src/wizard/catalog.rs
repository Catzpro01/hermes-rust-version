...
pub const PROVIDERS: [ProviderEntry; 39] = [
    ...
    ProviderEntry {
        ...
        description:
            "ChatGPT or Codex Subscription (Sign in with your ChatGPT account, uses Codex models)",
    },
    ProviderEntry {
        id: "openai-api",
        label: "OpenAI API",
    ...
    ProviderEntry {
        ...
        description:
            "Tencent TokenPlan (Hy4 preview via api.lkeap.cloud.tencent.com, Anthropic Messages)",
    },
    ProviderEntry {
        id: "nvidia",
        label: "NVIDIA NIM",
    ...
    ProviderEntry {
        ...
        description: "Vercel AI Gateway (Multi-model aggregator)",
    },
    ProviderEntry {
        id: "qwen-oauth",
...
pub const TOOLSETS: [ToolsetEntry; 26] = [
    ...
    ToolsetEntry {
        ...
        tools: "video_analyze (requires video-capable model)",
    },
    ToolsetEntry {
        key: "image_gen",
    ...
    ToolsetEntry {
        ...
        tools: "video_generate (text/image/reference)",
    },
    ToolsetEntry {
        key: "x_search",
        label: "🐦 X (Twitter) Search",
        tools: "x_search (requires xAI OAuth or XAI_API_KEY)",
    },
    ToolsetEntry {
        key: "tts",
    ...
    ToolsetEntry {
        ...
        tools: "voice transcription (gateway voice messages + voice mode)",
    },
    ToolsetEntry {
        key: "skills",
        label: "📚 Skills",
        tools: "list, view, manage",
    },
    ToolsetEntry {
        key: "todo",
        label: "📋 Task Planning",
    ...
    ToolsetEntry {
        key: "memory",
        label: "💾 Memory",
        tools: "persistent memory across sessions",
    },
    ToolsetEntry {
        key: "context_engine",
        label: "🧩 Context Engine",
        tools: "runtime tools from the active context engine",
    },
    ToolsetEntry {
        key: "session_search",
        label: "🔎 Session Search",
        tools: "search past conversations",
    },
    ToolsetEntry {
        key: "clarify",
    ...
    ToolsetEntry {
        key: "cronjob",
        label: "⏰ Cron Jobs",
        tools: "create/list/update/pause/resume/run, with optional attached skills",
    },
    ToolsetEntry {
        key: "homeassistant",
        label: "🏠 Home Assistant",
        tools: "smart home device control",
    },
    ToolsetEntry {
        key: "spotify",
        label: "🎵 Spotify",
        tools: "playback, search, playlists, library",
    },
    ToolsetEntry {
        key: "discord",
        label: "💬 Discord (read/participate)",
        tools: "fetch messages, search members, create thread",
    },
    ToolsetEntry {
        key: "discord_admin",
        label: "🛡️  Discord Server Admin",
        tools: "list channels/roles, pin, assign roles",
    },
    ToolsetEntry {
        key: "yuanbao",
        label: "🤖 Yuanbao",
        tools: "group info, member queries, DM",
    },
    ToolsetEntry {
        key: "computer_use",
        label: "🖱️  Computer Use (macOS/Windows/Linux)",
        tools: "background desktop control via cua-driver",
    },
];
