...
- [ ] Fixture test menggunakan `state.db` aktual Hermes Python.
- [ ] Mapping metadata/message fields penuh sesuai schema Hermes upstream.
- [ ] Concurrent resume/write integration test.
